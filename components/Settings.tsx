...
import type { Announcement, Chapter, UserTier, Student, StaffUser, UserRole } from '../types';
import { iconMap, Users, AlertTriangle, GitMerge, PieChart, ShieldCheck, GraduationCap, User, Search } from './Icons';
import { BookOpen, Layout, Megaphone, Save, Cog as SettingsIcon, Trash2, X, ChevronUp, ChevronDown, Plus, Pencil, CheckCircle, Eye, EyeOff } from './Icons';
                            ...
                            {isTierDropdownOpen && (
                                <div className="absolute top-full mt-1 w-full bg-white rounded-md shadow-lg border z-10 p-1 animate-fadeInUp" role="listbox">
                                    {(Object.keys(tierInfo) as UserTier[]).map(t => {
                                        const { name, Icon, color } = tierInfo[t];
